/*
  ...
  - Made the column `datahora_matricula` on table `EstudantesTurmasEscola` required. This step will fail if there are existing NULL values in that column.
...
CREATE TABLE "new_EstudantesTurmasEscola" (
    ...
    "datahora_matricula" TEXT NOT NULL,
